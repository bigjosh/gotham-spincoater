...
for _module in ('main','runtime','dashboard','portal','webpage','control','recipes','fan_settings','touch','touch_controls','stop_guard','pio_fan','combined_program','rig','ui','fan','sync_tach','sync_program','periods','open_drain_pwm','display','config'):
